...
use yew::{classes, Component, ComponentLink, html, Html, InputData, NodeRef, ShouldRender};
use yew::{Classes, events::KeyboardEvent};
use yew::format::Json;
...
fn main() {
    yew::start_app::<Model>();
    // let value  = Par{s: "boas".to_string(), b: false };
    // println!("{}","true");
}
